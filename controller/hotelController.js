...
exports.getHotelsWithin = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not find Hotels within", 500)
    );
  }
};
...
exports.getHotelDetails = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not find Hotels Details", 500)
    );
  }
};
...
exports.getHotelReviews = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not find Hotel reviews", 500)
    );
  }
};
