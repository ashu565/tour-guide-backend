...
exports.createHotelReview = async (req, res, next) => {
  try {
    ...
    if (!userBooking.length) {
      return next(
        new AppError("Only People who have visited this hotel can give review")
      );
    }
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not Create Review", 500)
    );
  }
};
...
exports.editHotelReview = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not Edit Review", 500)
    );
  }
};
...
exports.deleteHotelReview = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not Delete Review", 500)
    );
  }
};
...
exports.getAllReviews = async (req, res, next) => {
  try {
    ...
    console.log(err);
    return next(
      new AppError("Something went wrong, Could not retrieve all Reviews", 500)
    );
  }
};
...
exports.getTravellerCurrentBooking = async (req, res, next) => {
  try {
    ...
    return next(
      new AppError(
        "Something went wrong, Could not find Your Current Bookings",
        500
      )
    );
  }
...
exports.getTravellerPastBooking = async (req, res, next) => {
  try {
    ...
    return next(
      new AppError(
        "Something went wrong, Could not find Your Past Bookings",
        500
      )
    );
  }
